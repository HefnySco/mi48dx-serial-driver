...
inline const std::map<std::string, uint8_t> SerialCommandSender::MI48_REGMAP = {
    {"EVK_TEST", 0x00}, {"EVK_ID", 0xA5}, {"SENXOR_POWERUP", 0xB0}, {"FRAME_MODE", 0xB1},
    {"FW_VERSION_1", 0xB2}, {"FW_VERSION_2", 0xB3}, {"FRAME_RATE", 0xB4}, {"POWER_DOWN_1", 0xB5},
    {"STATUS", 0xB6}, {"POWER_DOWN_2", 0xB7}, {"SENXOR_TYPE", 0xBA}, {"MODULE_TYPE", 0xBB},
    {"SENS_FACTOR", 0xC2}, {"EMISSIVITY", 0xCA}, {"OFFSET_CORR", 0xCB}, {"FILTER_CTRL", 0xD0},
    {"FILTER_1_LSB", 0xD1}, {"FILTER_1_MSB", 0xD2}, {"FILTER_2", 0xD3}, {"FLASH_CTRL", 0xD8},
    {"SENXOR_ID_0", 0xE0}, {"SENXOR_ID_1", 0xE1}, {"SENXOR_ID_2", 0xE2}, {"SENXOR_ID_3", 0xE3},
